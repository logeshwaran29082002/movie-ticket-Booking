...
function AddPage() {
  ...
  // file helpers that render the image uploded by user
  ...
  }; // removee the image if picked or selected wrong
  ...
  // slots helpers  add remove and update slote timing for a movie(choose date , time and am/pm for that movie)
  function addSlot() {
    setSlots((s) => [
      ...s,
  ...
  // it reset the fields once the data gets submitted. to server
  function resetForm() {
    setMovieName("");
    setCategories([]);
    setPoster(null);
  ...
  //this function created the movie
                    ...
                    <div className={addMoviePageStyles.uploadContainer}>
                      {ltThumbnailPreview ? (
                        ...
                        <label className={addMoviePageStyles.uploadContent}>
                          <div
                            className={addMoviePageStyles.uploadIconContainer}
                          >
                            <ImageIcon
                      ...
                      <div className={addMoviePageStyles.gridCols3}>
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setStandardSeatPrice(e.target.value)
                            }
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setReclinerSeatPrice(e.target.value)
                            }
...
function ImageUploader({ title, onFiles, items, remove, icon, updateMeta }) {
  return (
    <>
      <div className={addMoviePageStyles.uploadContainer}>
        <div className={addMoviePageStyles.uploaderHeader}>
          <div className={addMoviePageStyles.uploaderTitle}>
            {icon}
            <h4 className={addMoviePageStyles.uploaderAddButton}>{title}</h4>
          </div>
...
{
  /* For the latestTrailer we NamedUploader */
}
